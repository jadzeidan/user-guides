...
Please check [this guide]({{site.baseurl}}/docs/bitbox01/Bacis%20features/managing_backups/#bitbox01-managing-backups) to verify that you have valid wallet backup and recovery password for the wallet you want to send your coins out of.
...
### Create new wallet
Now create the new wallet to which you want to send your coins. Follow [this guide](http://localhost:4000/docs/bitbox01/Getting_started/setup/) to do so.


### Verify and save receive addresses
Your BitBox01 should still be plugged in and unlocked.
1. [Verify and copy a receive address from your BitBox01]({{site.baseurl}}/docs/bitbox01/Bacis%20features/receive/) for each coin you want to sweep (i.e. Bitcoin, Litecoin) and paste it into a text file. Make sure you carefully check that it has been copied correctly.
...
To reset your BitBox01 follow this guide (link)
### Restore old wallet
Please follow [this guide]({{site.baseurl}}/docs/bitbox01/Bacis%20features/restore_from_backup/) to restore your old wallet.
