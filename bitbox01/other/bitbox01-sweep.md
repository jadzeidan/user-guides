...
### Create new wallet
Now create the new wallet to which you want to send your coins. Follow [this guide]({% link bitbox01/start/setup.md %}) to do so.
...
To reset your BitBox01 follow this guide (link)
### Restore old wallet
Please follow [this guide]({% link bitbox01/basics/restore-from-backup.md %}) to restore your old wallet.
